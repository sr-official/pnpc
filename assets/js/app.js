...
const teams = [
    ...
    new Team("Warriors (LLB)", 232, 228, 231, 227, 226, 0),
    ...
    new Team("Ideology Warriors(JRN)", 153, 157, 226, 233, 228, 0),
    ...
    new Team("Trio of Logic (BTE)", 227, 228, 232, 229, 226.5, 0),
...
const speakers = [
    ...
    new Speaker("Sumi", 77, 76, 77, 76, 76, 0),
    new Speaker("Oishorjo", 77, 76, 76, 75, 75, 0),
    new Speaker("Shihir", 78, 76, 78, 76, 75, 0),
    ...
    new Speaker("Md Soharaf", 76, 78, 75, 76, 75, 0),
    new Speaker("Shefa Ahmed", 77, 79, 76, 79, 77, 0),
    new Speaker("Sadia Farzana", 0, 0, 75, 78, 76, 0),
    ...
    new Speaker("Sahanaz Akter Any", 78, 76, 79, 77, 76, 0),
    new Speaker("Etika Jahan Lilika", 75, 75, 78, 76, 75.5, 0),
    new Speaker("Mahin Mahmud Emon", 74, 77, 75, 76, 75, 0),
    ...
    new Speaker("MD Sultanul Arfin", 76, 78, 77, 78, 76, 0),
    new Speaker("Nazmul Hasan Joy", 76, 77, 77, 76, 75, 0),
    new Speaker("Mohima Sultana Masuma", 77, 80, 78, 79, 75, 0),
...
const newsList = [
    ...
    { title: "Ajker Potrika", link: "https://www.ajkerpatrika.com/" },
